...
import com.amazonaws.services.dynamodbv2.datamodeling.encryption.EncryptionContextSDK2;
 ...
 * @author Greg Rubin 
 */
public class SymmetricStaticProviderSdk2 implements EncryptionMaterialsProviderSdk2 {
     ...
     */
    public SymmetricStaticProviderSdk2(SecretKey encryptionKey, KeyPair signingPair) {
     ...
     */
    public SymmetricStaticProviderSdk2(SecretKey encryptionKey,
     ...
     */
    public SymmetricStaticProviderSdk2(SecretKey encryptionKey, SecretKey macKey) {
     ...
     *            any {@link CryptographicMaterials} returned by this object.
     */
    public SymmetricStaticProviderSdk2(SecretKey encryptionKey, SecretKey macKey, Map<String, String> description) {
