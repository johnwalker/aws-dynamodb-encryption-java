 ...
 * {@link #getEncryptionMaterials(EncryptionContextSDK2)}. Practically, this means each record in DynamoDB will be
 ...
 * @author Greg Rubin 
 */
public class WrappedMaterialsProviderSdk2 implements EncryptionMaterialsProviderSdk2 {
     ...
     *            encryption.
     */
    public WrappedMaterialsProviderSdk2(Key wrappingKey, Key unwrappingKey, KeyPair signingPair) {
     ...
     */
    public WrappedMaterialsProviderSdk2(Key wrappingKey, Key unwrappingKey, KeyPair signingPair, Map<String, String> description) {
     ...
     */
    public WrappedMaterialsProviderSdk2(Key wrappingKey, Key unwrappingKey, SecretKey macKey) {
     ...
     *            {@link CryptographicMaterials} returned by this object.
     */
    public WrappedMaterialsProviderSdk2(Key wrappingKey, Key unwrappingKey, SecretKey macKey, Map<String, String> description) {
        this.wrappingKey = wrappingKey;
        this.unwrappingKey = unwrappingKey;
        this.sigPair = null;
        this.macKey = macKey;
